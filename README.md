...
| Discord消息转发 | [`plugins.v2/discordmsgforward`](plugins.v2/discordmsgforward) | 轮询 Discord 频道新消息并转发到指定通知渠道（可多选），支持每频道独立规则、关键词过滤、兑换码提取、图片转发、消息聚合与自定义模板。详见插件目录内 README。 |
