...
| Discord消息转发 | [`plugins.v2/discordmsgforward`](plugins.v2/discordmsgforward) | 将 Discord 频道新消息转发到指定通知渠道（可多选），支持频道下拉选择、关键词/作者/屏蔽词过滤、图片转发、消息聚合、免打扰时段、自定义模板与失败告警。详见插件目录内 README。 |
